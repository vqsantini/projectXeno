    ...
    <main>
      ...
      <section id="stories-section">
        <div className="container">
          <h2 className="h2-type">Vozes que constroem pontes</h2>
          ...
          <div className="story-card">
            <h3 className="h2-type">"O idioma era a menor das barreiras"</h3>
            <blockquote>
          ...
          <div className="story-card">
            <h3 className="h2-type">"Meu diploma não valia nada aqui"</h3>
            <blockquote>
          ...
          <div className="story-card">
            <h3 className="h2-type">"Um prato de comida mudou tudo"</h3>
            <blockquote>
